...
// console.log(`${spacecraftName} has ${daysToMars} days to reach Mars.`);
...
//console.log(`${spaceShuttle.name} has ${spaceShuttle.getDaysToLocation(kilometersToMars)} days to reach Mars.`);
//console.log(`${spaceShuttle.name} has ${spaceShuttle.getDaysToLocation(kilometersToTheMoon)} days to reach the Moon.`);
